...
export default function LensPage() {
  const course = courses.find(c => c.title === "Lens");
  const { email, setEmail, isSubmitted, handleSubmit } = useWaitlist({ waitlistFeature: 'Lens' });
  ...
  return (
    <div className="container mx-auto p-8 flex flex-col items-center justify-center min-h-[60vh] text-center">
      ...
      <div className="w-full max-w-4xl mb-8">
        <Image 
          src={course?.imageUrl || "/img/Lens/Lens.webp"}
          alt="Lens course"
          width={1000}
          height={600}
